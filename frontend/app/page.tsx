...
export default function Home() {
  ...
  return (
    <div className="bg-black w-full min-h-screen flex flex-col items-center justify-center gap-4">
      ...
      <button className="cursor-pointer bg-[#FF007F] hover:bg-[#FF3399] transition-colors duration-200 py-3 px-10 rounded-lg text-lg font-semibold" onClick={() => router.push("/auth/login")}>Login</button>
    </div>
  );
}
